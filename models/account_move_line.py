...
class AccountMoveLine(models.Model):
    ...
    def _get_computed_taxes(self):
        ...
        # In Odoo 19 the parent already applies fiscal position mapping.
        # We only intervene when no taxes were found, adding the company default
        # and mapping it through the fiscal position ourselves.
        if not tax_ids and self.display_type == 'product':
            ...
            if tax_ids and self.company_id:
